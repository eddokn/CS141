...
approx_reindeer = "12.4"
print("The approximate number of reindeer is ", approx_reindeer, sep="")

# convert the approximate decimal value to an integer
# (drop the decimal point using the int conversion function)
num_reindeer = int(float(approx_reindeer))

# print the whole number of reindeer
print("The whole number of reindeer is ", num_reindeer, sep="")
